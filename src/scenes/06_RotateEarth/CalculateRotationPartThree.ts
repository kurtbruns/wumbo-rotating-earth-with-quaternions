...
export class CalculateRotationPartThree extends MapMouseToPointAndRotate {
    constructor() {
        ...
        this.reset = () => {
            ...
            dotProductFormula.setAttribute('opacity', '0');
            magnitudeOfCrossProductFormula.setAttribute('opacity', '0');
            this.clear();

            this.wait();

            this.play([
                dotProductFormula.animate.setOpacity(1),
            ], 1);

            this.wait()

            this.play([
                magnitudeOfCrossProductFormula.animate.setOpacity(1),
            ], 1);
