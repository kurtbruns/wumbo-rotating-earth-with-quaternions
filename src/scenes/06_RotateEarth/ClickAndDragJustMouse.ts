...
export interface ClickAndDragJustMouseOptions {
    mouseStartX?: number;
    mouseStartY?: number;
    mouseEndX?: number;
    mouseEndY?: number;
...
export class ClickAndDragJustMouse extends EarthScene {
    ...
    constructor(options: ClickAndDragJustMouseOptions = {}) {
        ...
        this.mouse.update = () => {
            ...
            const localX = startX + this.t.value * (endX - startX);
            const localY = startY + this.t.value * (endY - startY);
        ...
        this.reset = () => {
            ...
            this.displayMouse.setOpacity(0);
            ...
            this.wait(1.5)
            this.play([
                this.displayMouse.animate.setOpacity(1)
            ])
            this.play([
            ...
            this.play([
                this.t.animate.setValue(0)
            ], config.firstAnimationDuration - 1)

            this.play([
                this.displayMouse.animate.setOpacity(0)
            ])
