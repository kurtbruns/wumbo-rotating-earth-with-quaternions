...
// export class PropSceneBallZoomed extends QScene {
...
//         // let normalToCamera = this.drawNormalToCamera();
...
//         this.play([
//             // this.camera.animate.change(Quaternion.identity(), 4.4),
...
//                     // let u = this.viewPort.plot.SVGToRelative(Math.cos(a), Math.sin(a));
//                     // console.log(Math.cos(a), Math.sin(a))

//                     // let u = new Vector3(Math.cos(a), Math.sin(a));
