...
export class ExponentsIntuitionOriginal extends SphereScene {
    ...
    constructor() {
        ...
        let xShift = 0
        let spacing = 32
        let q1Tex = this.viewPort.frame.tex(`q_1 = ${this.q.toFormattedString()}`);
        q1Tex.setAttribute('font-size', '18px');
        q1Tex.moveTo(this.viewPort.frame.width / 2 - xShift, spacing);
        q1Tex.alignCenter();

        let q2Tex = this.viewPort.frame.tex(`q_2 = r \\cdot q_1`);
        q2Tex.setAttribute('font-size', '18px');
        q2Tex.moveTo(this.viewPort.frame.width / 2 - xShift, 2*spacing);
        q2Tex.alignCenter();
        q2Tex.setAttribute('opacity', '0')
        Tex.alignHorizontallyBy(q1Tex, q2Tex, '=')


        let q3Tex = this.viewPort.frame.tex(`q_3 = r \\cdot r \\cdot q_1`);
        q3Tex.setAttribute('font-size', '18px');
        q3Tex.moveTo(this.viewPort.frame.width / 2 - xShift, 3*spacing);
        q3Tex.setAttribute('opacity', '0')
        q3Tex.alignCenter();

        Tex.alignHorizontallyBy(q2Tex, q3Tex, '=')
        ...
        angleTex.moveTo(this.viewPort.frame.width / 2, this.viewPort.frame.height - 105);
        ...
        Tex.alignHorizontallyBy(rotationTex, angleTex, '=')
