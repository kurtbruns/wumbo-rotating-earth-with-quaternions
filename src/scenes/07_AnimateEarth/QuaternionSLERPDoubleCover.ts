...
export class QuaternionSLERPDoubleCover extends SphereOrientationSideBySide {
    ...
    constructor(shortestPath: boolean = false) {
        ...
        this.reset = () => {
            ...
            this.play([
                ...
                this.negativeAxisRight.animate.setOpacity(1),
            ])
            ...
            this.play([
                w.animate.setValue(1 - 1/12),
            ], 3)

            this.wait()

            // this.play([
            //     this.positiveAxisRight.animate.setOpacity(0),
            //     this.negativeAxisRight.animate.setOpacity(0),
            // ], 1)
        }
