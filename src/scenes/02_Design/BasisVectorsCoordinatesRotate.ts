...
export class BasisVectorsCoordinatesRotate extends SphereScene {
    ...
    constructor() {
        ...
        let sphereLabels = this.viewPort.frame.group();
        ...
        sphereLabels.appendChild(iLabelSphere);
        sphereLabels.appendChild(jLabelSphere);
        sphereLabels.appendChild(kLabelSphere);
        ...
        this.reset = () => {
            ...
            this.play([
                this.q.animate.rotate(new Vector3(-1, 1, 0), -Math.PI / 2 + Math.PI / 12),
            ], 5)

            this.wait()

            this.play([
                this.q.animate.rotate(new Vector3(0, 1, 0), Math.PI / 2 ),
            ], 5)
            ...
            this.play([
                ...
                // sphereLabels.animate.setOpacity(0),
            ], 5)

            this.wait()

            this.play([
                iLabel.animate.setOpacity(0),
                jLabel.animate.setOpacity(0),
                kLabel.animate.setOpacity(0),
                iLabelTransformed.animate.setOpacity(0),
                jLabelTransformed.animate.setOpacity(0),
                kLabelTransformed.animate.setOpacity(0),
            ], 1)

            this.play([
                this.q.animate.slerp(startingQuaternion),
            ], 3)
