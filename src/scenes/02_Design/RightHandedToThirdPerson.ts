...
export class RightHandedToThirdPerson extends QScene {
    ...
    constructor() {
        ...
        super({
            ...
            size: 1.8,
            cameraOrientation: cameraOrientation2.copy(),
            cameraPosition: cameraPosition2.copy(),
        });
        ...
        // Start with sphere visible
        this.play([
            sphere.animate.setOpacity(1)
        ]);

        // Animate from right-handed to third-person view
        this.play([
            this.camera.animate.change(cameraOrientation),
            this.camera.animate.moveTo(cameraPosition),
        ], 5);
